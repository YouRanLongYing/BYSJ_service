...
namespace SimpleService
{
	...
	class StateObject
	{
		public const int BufferSize = 1024;//8196
	...
	public class Transporter
	{
		...
		private void endReceive(IAsyncResult asyncReceive){
			...
			if (length > 0) {
				...
				if(this.transportState != TransportState.closed) 
				{
					System.Console.WriteLine("EndReceive failed!");
					receive ();
		...
		/// <summary>
		/// 处理数据，根据TransportState进行判断，调用相应的方法
		/// </summary>
		/// <param name="bytes">需要处理的数据</param>
		/// <param name="offset">开头的偏移量，起点</param>
		/// <param name="limit">限制的长度</param>
		...
		/// Reads the head.
		/// </summary>
		/// <returns><c>true</c>, if head was  read, <c>false</c> otherwise.</returns>
		/// <param name="bytes">需要处理的数据</param>
		/// <param name="offset">bytes开头的偏移量，起点</param>
		/// <param name="limit">限制的长度</param>
